module.exports = [
    {
        ...
        <p>Medialab is an online sharing platform started in Amsterdam 2007. They focus on storing, transferring an sharing media online. The support page of Medialab allows people contact Medialab or view frequently asked questions.</p>
        <h3>The assignment</h3>
        <p>The old design of the site didn’t represent Medialab. It had different colors and a different layout than the landingpage. My assignment was to rebuild the current website to match the identity of the company.</p>
        <h3>Workflow</h3>
        <ol>The assignment was split into four parts:
    ...
    },
    {
        ...
        <p>We used OpenCart as a backend. OpenCart is an ecommerce platform design for webshops, it helped us give the client an overview of the purchases and order history.</p>

        <h3>My Role</h3>
        <p>During this project I took the role as the Backend and Frontend developer. I was mainly responsible for the code that was delivered, but I also played a huge parted in the concepting and testing of the project.</p>

        <h3>Result</h3>
        <p>Daskas two main concepts:</p>
        <ul>
    ...
    },
    {
		...
		summary: "Funda serverside is a site optimatation audit done for Funda.nl. A serie of test were done to illustrate how the current site could be optimized",
        content: `Funda serverside is an serverside application that runs on Node.js + Express. This project was build to illustrate a few performance patterns that could optimize the speed of the current Funda website. Funda serverside is based on the existing <a href="www.funda.nl">Funda site</a>.

		<h3>What does it do</h3>
		<p>Funda serverside allows users to search and get information about houses in the Netherlands that are registered on Funda.</p>
		<p>A series of tests were done with the Google Chromes internet connection throttling. This Google Chrome tool is a great way to emulate how people with slow connection experience a website. The connections on which the tests were done exist of GPRS, Good 2G, Good 3G, Regular 4G and Wifi with disabled cache.</p>

        <h3>Results</h3>
		<p>The site became much faster after applying the optimatation.</p>
        <ul>
            <li>Rendering files on the server will give the website a boost in performance.</li>
            <li>Loading page async helps the DOM content te be loaded much faster.</li>
            <li>I didn't succeed on making the images smaller, but I managed to get a higher score on Google's <a href="https://developers.google.com/speed/pagespeed/insights/?hl=nl">PageSpeed insights</a> for mobile .</li>
    ...
    },
    {
		...
		summary: "Soundcloud explorer is a music search website build with HTML, CSS and JavaScript. It allows the user to search and play songs that are available on Soundcloud",
        content: `This website uses the Soundcloud API to search songs and plays it directly on the page. Soundcloud explorer was build as a three week project during a school Minor web-development. The main focus was to learn Object Oriented Programming Javascript.
    ...
    },
    {
		...
		image: "/static/zoku/zoku-compressed1.jpg",
		image_list: [
		...
		summary: "Zoku Inspire is a prototype that should aid the visitors of the Zoku hotel with a social bond in and outside of the hotel. Hotel guests can use this app to host and attend workshops.",
        content: `
        <h3>About Zoku</h3>
		<p>Zoku is a new concept in the hotel industry. Their goal is to bring people together under one roof. It's not just a hotel, it's a place where people can share knowledge, ideas and get to know inspiring people and companies.</p>

		<h3>Concept</h3>
		<p>Zoku Inspire is a way to get the guests of the Zoku hotel familiar with the city. By sharing knowledge, guests will meet new people with common interest.</p>

        <h3>How does it work</h3>
		<p>A visitor of the Zoku hotel can use his/her mobile phone to create a workshop. This workshop will be displayed on a bigger screen, at a central point in the hotel lobby.</p>
		`,
        author: "Elton Gonçalves Gomes",
		client: "Hotel Zoku",
    ...
    },
	{
		...
		content: `
        <h3>About the project</h3>
		<p>This project is a sequencer that allows users to make sounds with 8 instruments. The app allows users to interact with keyboard keys or with mouse.</p>
		`,
		author: "Elton Gonçalves Gomes",
		client: "Free project",
